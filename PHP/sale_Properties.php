...
$saleProperties = getHighlightedProperties($pdo, 'venta');
...
<head>
    ...
    <title>Propiedades en Venta Destacadas</title>
...
<body>
    <section class="container-Properties textCard" style="width: 100%; height: 100vh;">
        <h1 style="text-align: center; margin-bottom: 20px;">TODAS LAS PROPIEDADES EN VENTA</h1>
        <div class="container">
